(function () {
  ...
  class Styler {
      constructor(options = {}) {
          ...
          this.generateStyle = (layer, options) => {
              ...
              else if ((!styleIdMatch || (styleIdMatch === null || styleIdMatch === void 0 ? void 0 : styleIdMatch.remote)) && styleNameMatch && updateUsingLocalStyles === false) {
              ...
              else if (styleIdMatch && !(styleIdMatch === null || styleIdMatch === void 0 ? void 0 : styleIdMatch.remote) && !styleNameMatch && updateUsingLocalStyles === true) {
                  this.renameStyle(layer, styleIdMatch);
                  counter.renamed++;
              }
              //
  ...
  class Config {
      constructor(options = defaultSettings) {
          const { 
          // general
          addPrevToDescription = defaultSettings.addPrevToDescription, framesPerSection = defaultSettings.framesPerSection, textsPerSection = defaultSettings.textsPerSection, notificationTimeout = defaultSettings.notificationTimeout, updateUsingLocalStyles = defaultSettings.updateUsingLocalStyles, partialMatch = defaultSettings.partialMatch, 
          // stylers
