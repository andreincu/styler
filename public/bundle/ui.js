var ui = (function (svelte) {
    ...
    // (135:0) {#each checkboxes as checkbox}
    ...
    // (163:2) <Button on:click="{resetToDefault}" variant="secondary" class="col">
    ...
    // (164:2) <Button on:click="{saveSettings}" class="col">
